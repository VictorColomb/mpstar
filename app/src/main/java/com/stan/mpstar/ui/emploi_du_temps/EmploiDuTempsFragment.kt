package com.stan.mpstar.ui.emploi_du_temps
...
class EmploiDuTempsFragment : Fragment() {
    ...
    private fun loadTimetableDisplay(edtToday :Map<Int, String>, monday :Date, dayString :String) {
        ...
        while (i<edtToday.size) {
            ...
            if (!((colleMathsData.myDay == dayString && colleMathsData.myTime == i) || (colleAutreData.myDay == dayString && colleAutreData.myTime == i))) {j+=1}
